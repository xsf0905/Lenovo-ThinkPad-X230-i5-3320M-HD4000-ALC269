...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<ul class=\"js-autocomplete\" style=\"", "\">\n        ", "\n    </ul>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<section class=\"sliding-subview grade-scorecard sliding-subview--has-fixed-header\">\n    <div class=\"site-info site-info--full-height card\">\n        ", "\n        ", "\n        ", "\n    </div>\n</section>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<button type=\"button\" class=\"hamburger-button ", "\" aria-label=\"More options\">\n    <span></span>\n    <span></span>\n    <span></span>\n</button>"]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<a href=\"javascript:void(0)\"\n        class=\"hero__", "\"\n        role=\"button\"\n        aria-label=\"", "\"\n        >\n    <span class=\"icon icon__arrow icon__arrow--large ", "\">\n    </span>\n</a>"]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<span>Site enhanced from\n    <span class=\"rating-letter rating-letter--", "\">\n    </span>\n</span>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<div class=\"rating-hero-container js-rating-hero\">\n     ", "\n</div>"]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<li class=\"status-list__item status-list__item--", "\n    bold ", "\">\n    ", "\n</li>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<ul class=\"status-list ", "\">\n    ", "\n</ul>"]);
...
function trackersBlockedOrFound(site, trackersCount) {
  ...
  return bel(_templateObject2(), msg);
}
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<a href=\"javascript:void(0)\" class=\"site-info__trackers link-secondary bold\">\n    <span class=\"site-info__trackers-status__icon\n        icon-", "\"></span>\n    <span class=\"", " text-line-after-icon\"> ", " </span>\n    <span class=\"icon icon__arrow pull-right\"></span>\n</a>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<span class=\"top-blocked__pill-site__icon ", "\"></span>"]);
...
function _templateObject5() {
  var data = _taggedTemplateLiteral(["<ol class=\"default-list top-blocked__list\">\n    <li class=\"top-blocked__li top-blocked__li--no-data\">\n        ", "\n    </li>\n</ol>"]);
...
function _templateObject4() {
  var data = _taggedTemplateLiteral(["<ol aria-label=\"List of Trackers Found\" class=\"default-list top-blocked__list card border--bottom\">\n    ", "\n</ol>"]);
...
function _templateObject3() {
  var data = _taggedTemplateLiteral(["<p class=\"top-blocked__pct card\">\n    Trackers were found on <b>", "%</b>\n    of websites you've visited", ".\n</p>"]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<div class=\"js-top-blocked-content\">\n    ", "\n    ", "\n    ", "\n</div>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<div class=\"sliding-subview\n    sliding-subview--has-fixed-header top-blocked-header\">\n    ", "\n</div>"]);
...
function _templateObject4() {
  var data = _taggedTemplateLiteral(["<li class=\"is-empty\"></li>"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<section class=\"sliding-subview\n    sliding-subview--has-fixed-header\">\n</section>"]);
