...
module.exports = function (uaString) {
  ...
  try {
    ...
    version = parsedUaParts[2]; // in Safari, the bit immediately after Safari/ is the Webkit version
...
function _templateObject6() {
  var data = _taggedTemplateLiteral(["<p>Something went wrong when submitting feedback. Please try again later!</p>"]);
...
function _templateObject5() {
  var data = _taggedTemplateLiteral(["<p>Thank you for your feedback!</p>"]);
